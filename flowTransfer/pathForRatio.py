...
plt.plot(sourceMessage, firstPart1, color=colors[0], label="AODV")  # s-:方形
plt.plot(sourceMessage, firstPart2, color=colors[1], label="JamRoute")  # o-:圆形
plt.plot(sourceMessage, firstPart3, color=colors[2], label="AMRBEC")  # o-:圆形
# plt.plot(time, firstPart4, color=colors[3], label="GWO-DRL1")  # o-:圆形
plt.plot(sourceMessage, firstPart5, color=colors[4], label="GWO-DRL2")  # o-:圆形



plt.ylabel("Completion Rate")
plt.xlabel("Send Rate(Byte/s)")
