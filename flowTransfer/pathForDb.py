...
plt.plot(NoooRate, firstPart1, color=colors[0], label="AODV")  # s-:方形
plt.plot(NoooRate, firstPart2, color=colors[1], label="JamRoute")  # o-:圆形
plt.plot(NoooRate, firstPart3, color=colors[2], label="AMRBEC")  # o-:圆形
# plt.plot(time, firstPart4, color=colors[3], label="GWO-DRL1")  # o-:圆形
plt.plot(NoooRate, firstPart5, color=colors[4], label="GWO-DRL")  # o-:圆形
